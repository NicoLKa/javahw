alert("Test: творческая ли вы натура? ");
let ask = ['1.Обнаружив, что любимые джинсы порвались, вывыкидываете их — 0\n делаете еще несколько художественных разрезов и продолжаете носить — 1',
    ...
    '8. Для новогоднего маскарада в детском саду необходимо найти малышу костюм. Вы сошьете его сами — 1 купите в магазине — 0',
